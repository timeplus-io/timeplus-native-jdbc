...
public class DataTypeInt128 implements IDataType<BigInteger, BigInteger> {
    ...
    public int getPrecision() {
        return 40;  //should be 39 but add one
    }
    ...
    public void serializeBinary(BigInteger data, BinarySerializer serializer) throws SQLException, IOException {
        serializer.writeBigInteger(data, 16);
    }
    ...
    public BigInteger deserializeText(SQLLexer lexer) throws SQLException {
        String Integer128 = lexer.stringLiteral();
