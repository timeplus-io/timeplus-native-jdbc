...
public class ColumnAggregationFunction extends AbstractColumn {

    // data represents nested column in ColumnArray
    private final IColumn[] columnDataArray;

    public ColumnAggregationFunction(String name, DataTypeAggregationFunction type, Object[] values) {
